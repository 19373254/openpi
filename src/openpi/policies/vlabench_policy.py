...
@dataclasses.dataclass(frozen=True)
class VLABenchInputsCameraA(transforms.DataTransformFn):
    """
    This class is used to convert inputs to the model to the expected format. It is used for both training and inference.
    ...
    def __call__(self, data: dict) -> dict:
        ...
        inputs = {
            "state": state,
            "image": {
                "base_0_rgb": np.zeros_like(image_0),
                "left_wrist_0_rgb": np.zeros_like(image_0),
                # "left_wrist_0_rgb": wrist_image,
                # Pad any non-existent images with zero-arrays of the appropriate shape.
...
@dataclasses.dataclass(frozen=True)
class VLABenchInputsCameraB(transforms.DataTransformFn):
    """
    This class is used to convert inputs to the model to the expected format. It is used for both training and inference.
    ...
    def __call__(self, data: dict) -> dict:
        ...
        inputs = {
            "state": state,
            "image": {
                "base_0_rgb": np.zeros_like(image_1),
                "left_wrist_0_rgb": np.zeros_like(image_1),
                # "left_wrist_0_rgb": wrist_image,
                # Pad any non-existent images with zero-arrays of the appropriate shape.
...
@dataclasses.dataclass(frozen=True)
class VLABenchInputsCameraBC(transforms.DataTransformFn):
    """
    This class is used to convert inputs to the model to the expected format. It is used for both training and inference.
    ...
    def __call__(self, data: dict) -> dict:
        ...
        # wrist_image = _parse_image(data["observation/wrist_image"])
        image_1 = _parse_image(data["observation/image_1"])
        image_2 = _parse_image(data["observation/image_2"])
        # Create inputs dict. Do not change the keys in the dict below.
        inputs = {
            "state": state,
            "image": {
...
@dataclasses.dataclass(frozen=True)
class VLABenchInputsCameraBCDE(transforms.DataTransformFn):
    """
    This class is used to convert inputs to the model to the expected format. It is used for both training and inference.
    ...
    def __call__(self, data: dict) -> dict:
        ...
        image_1 = _parse_image(data["observation/image_1"])
        image_2 = _parse_image(data["observation/image_2"])
        image_3 = _parse_image(data["observation/image_3"])
        # Create inputs dict. Do not change the keys in the dict below.
        inputs = {
            "state": state,
            "image": {
...
@dataclasses.dataclass(frozen=True)
class VLABenchInputsCameraWrist(transforms.DataTransformFn):
    """
    This class is used to convert inputs to the model to the expected format. It is used for both training and inference.
